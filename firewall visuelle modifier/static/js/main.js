 ...
 * main.js — Premium v2.0
 * Inclut : Modal, Flash, Session, Ripple, 3D Tilt, Stagger Reveal
 */
...
function showSessionWarning() {
    ...
    warning.innerHTML = `
        <div class="warning-content">
            ...
            <button class="warning-dismiss" onclick="this.closest('.session-warning').remove()">OK</button>
        </div>`;
...
// =============================================================================
// 7. EFFET 3D TILT sur les mode-cards
// =============================================================================
document.addEventListener('DOMContentLoaded', () => {
    document.querySelectorAll('.mode-card').forEach(card => {
        card.addEventListener('mousemove', (e) => {
            ...
            const tiltX = (-dy * 5).toFixed(2);   // max ±5°
            const tiltY = ( dx * 5).toFixed(2);
            card.style.transform =
                `perspective(900px) rotateX(${tiltX}deg) rotateY(${tiltY}deg) translateY(-6px)`;
        });
...
// Déclenché quand la section packs devient visible (toggle)
const _origTogglePacks = window.togglePacks;
window.togglePacks = function() {
    if (typeof _origTogglePacks === 'function') _origTogglePacks();
    // Laisser le DOM s'afficher puis déclencher le stagger
    setTimeout(revealPackCards, 60);
};

// Si les packs sont déjà visibles au chargement (mode partiel actif)
document.addEventListener('DOMContentLoaded', () => {
...
// =============================================================================
// 9. CODE DIGIT : marque les cases remplies (classe .filled)
// =============================================================================
document.addEventListener('DOMContentLoaded', () => {
...
// =============================================================================
// 11. INJECTION DES KEYFRAMES RUNTIME (ripple + shimmer)
// =============================================================================
